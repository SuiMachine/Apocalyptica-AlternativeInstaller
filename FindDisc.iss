//  Apocalyptica
//  Modified for Apocalyptica by SuicideMachine
...
begin
	...
	begin
		...
		begin
			if MsgBox('Is there a Apocalyptica CD in your computer? If not, please insert it and press OK.', mbConfirmation, MB_OKCANCEL or MB_DEFBUTTON1) = IDOK then
